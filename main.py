...
def main():
    ...
    print("=======================================================")
    print("1. Laporan CSV: output/results/benchmark_results.csv")
    print("2. Sampel mentah: output/results/raw_samples.csv")
    print("3. Info lingkungan: output/results/environment.json")
    print("4. Ringkasan size sweep: output/results/size_sweep_summary.csv")
    print("5. Grafik statis: output/charts/latency_comparison.png")
    print("6. Boxplot latensi: output/charts/latency_boxplot.png")
    print("7. Grafik size sweep: output/charts/size_sweep.png")
    print("8. Untuk melihat dashboard interaktif, jalankan:")
