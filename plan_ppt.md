...
Presentasi 20 menit: 1 slide judul (0:15) dan 18 slide isi (19:45). Dokumen ini hanya berisi isi dan layout, disusun agar bisa dibuat langsung di Canva. Angka diambil dari `output/results/*.csv`.
...
| 2 | B | 12 | C |
| 3 | A | 13 | C |
| 4 | A | 14 | B (empat kartu) |
| 5 | D | 15 | C |
| 6 | A | 16 | C (visual penuh) |
| 7 | C | 17 | A |
| 8 | D | 18 | B |
| 9 | A | | |

Semua grafik angka (slide 12, 13, 15) dibuat sebagai chart bawaan Canva, bukan gambar, supaya anggota lain bisa mengedit datanya dan warnanya mengikuti Brand Kit.
...
### 3. Ruang lingkup dan batasan (0:45) · Layout A
...
### 6. Penelitian terkait dan posisi kita (0:45) · Layout A
...
## Bagian 3: Metodologi dan Sistem (5:15)

### 7. Arsitektur pipeline (1:15) · Layout C
...
### 8. Dataset dan prosedur uji (1:00) · Layout D
...
### 9. Implementasi cipher (1:15) · Layout A
...
### 10. Skenario tambahan (1:00) · Layout E
...
### 11. Validasi kebenaran (0:45) · Layout B
...
### 12. Latensi per file (1:15) · Layout C
...
### 13. Size sweep dan titik potong (1:45) · Layout C
...
### 14. Overhead ukuran (1:00) · Layout B (empat kartu)
...
### 15. Mengapa AES-GCM menang di data besar (1:15) · Layout C
...
## Bagian 5: Dashboard dan Penutup (3:30)

### 16. Dashboard visualisasi (0:45) · Layout C (visual penuh)
...
### 17. Perubahan dari proposal dan batasan (1:15) · Layout A
...
### 18. Kesimpulan dan rekomendasi (1:30) · Layout B
...
- Slide "Terima kasih" untuk tanya jawab menyusul di luar 18 slide isi.
...
| Slide | Aset | Sumber |
|---|---|---|
| 7 | Diagram alur | `assets/codeflow.png` |
| 9 | Potongan kode | `src/aead.py` |
